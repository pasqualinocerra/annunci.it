...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    @if (auth()->user())
                        ...
                        <div class="me-3">
                            <a class="nav-link" href="/nuoveRevisore">Diventa revisore</a>
                        </div>
                    @endif
    ...
    <div class="container">
        <form action="{{ route('richiesta.revisore')}}" method="POST">
            @csrf
            <div class="row row-cols-1 row-cols-md-3 g-4">
                ...
                <div class="col-6">
                    <button type="submit" class="btn btn-primary mt-3">Diventa revisore</button>
                </div>
                @if (session('status'))
