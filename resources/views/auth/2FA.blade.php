            ...
            @auth 
                @if (!auth()->user()->two_factor_secret)
                    ...
                    <div>
                        <form action="{{ route('two-factor.enable') }}" method="post">
                            @csrf
                        <button type="submit" class="btn btn-outline-success">Abilita 2FA</button>
                    </div>
                ...
                @else
                    ...
                    <div>
                        ...
                        <h5>Completa l'abilitazione scansionando il QR Code di Google Authenticator</h5>
                        <br>
                        {!! auth()->user()->twoFactorQrCodeSvg() !!}

                        <form action="{{ route('two-factor.confirm') }}" method="post">
                            @csrf
                            <label for="code">Inserisci il codice numerico</label>
                    ...
                    @endif
                        ...
                        <form action="{{ route('two-factor.disable') }}" method="post">
                            @csrf
                            @method('DELETE')
                        <button type="submit" class="btn btn-outline-danger">Disabilita 2FA</button>
                    </div>
                @endif
