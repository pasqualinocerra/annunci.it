...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="me-3">
                    <a href="">
                        <img src="it.png" alt="italiano" width="35">
                    </a>
                </div>
                <div class="me-3">
                    <a href="">
                        <img src="en.png" alt="inglese" width="30">
                    </a>
                </div>
                <div class="me-3">
                    <a href="">
                        <img src="sp.png" alt="spagnolo" width="30">
                    </a>
                </div>
    ...
    <main>
        <h1>Benvenuti su Annunci.it!</h1>
        <h2>I nostri annunci</h2>

        <div class="container">
            @if (session('revisorMessage') == 'ok')
                <div class="alert alert-success mt-3">
                    COMPLIMENTI SEI DIVENTATO REVISORE!
                </div>
            @endif
            <div class="row row-cols-1 row-cols-md-3 g-4">
                @foreach ($annunci as $annuncio)
                    <div class="col">
                        <div class="card">
                            <img src="xbox.jpg" class="card-img-top" alt="">
                            <div class="card-body">
                                <h5 class="card-title">{{$annuncio->titolo}}</h5>
                                <p class="card-text">{{$annuncio->descrizione}}</p>
                                <p class="card-text">{{$annuncio->prezzo}} euro</p>
                            </div>
                        </div>
                    </div>
                @endforeach
